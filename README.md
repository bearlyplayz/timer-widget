...
| **Font color**              | Select the color for the text of the widget.                                                                                                              | Black                 |
| **Font size**               | Select the size of the text in the widget.                                                                                                                | 50                    |
| **Filler color**            | Color of the filler bar that decreases as the timer goes down.                                                                                            | Semi transparent blue |
